...
const App = () => {
  ...
  useEffect(() => {
    axios
      .get("https://phonebookbackend-production-942d.up.railway.app/api/persons")
      .then(response => {
  ...
  const addPerson = (event) => {
    ...
    if (duplicates === 0) {
      ...
      axios.post('https://phonebookbackend-production-942d.up.railway.app/api/persons', newPersonObj)
